...
<div class="relative px-4 pt-10 h-[50vh] max-w-5xl mx-auto">
  <div class="absolute flex flex-col gap-10 pt-32">
    ...
    <div class="flex gap-6">
      <div class="w-6"><a href={sparrowData.github}> <GitHub /></a></div>
      <div class="w-6"><a href={sparrowData.twitter}> <Twitter /></a></div>
      <div class="w-6"><a href={sparrowData.website}> <Website /></a></div>
    </div>
  ...
  <img src="/wallets-bg/sparrow-bg.png" alt="Sparrow Logo" />
</div>
<div>
  <FlatCoinjoinSvg />
</div>

...
{#if screenSize > 767}
  <div
    class="flex items-center relative w-full isolate z-0 h-[70vh] md:h-[80vh]"
  >
  ...
  {#if isLoaded}
    ...
    >
      ...
      <div class="w-full h-[calc(50vh)]">
        ...
        <div
          class="w-10 eye-move-down eye-12 absolute block bottom-10 right-10"
        >
          <Eye />
        </div>
        ...
        <div
          class="w-10 eye-move-down eye-10 absolute block bottom-28 right-20"
        >
          <Eye />
        </div>
      </div>
  ...
  {#if y > 7400}
    ...
    >
      ...
      <div
        class="text-white max-w-5xl mx-auto flex flex-col gap-12 flex-1 pt-12"
      >
  ...
  {#if y > 9000}
    ...
    >
      <div
        class="flex flex-col items-start gap-14 max-w-3xl text-center mx-auto"
      >
